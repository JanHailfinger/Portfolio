...
<div class="container mt-5">
    <h1 class="mb-4">Datenschutz&shy;erkl&auml;rung</h1>
    ...
    <p><?php echo $ini["admin_name"] ?><br />
        <?php echo $ini["admin_adress"] ?><br />
        <?php echo $ini["admin_zip"] ?></p>

    <p>Telefon: <?php echo $ini["admin_phone"] ?><br />
        E-Mail: <?php echo $ini["admin_email"] ?></p>
